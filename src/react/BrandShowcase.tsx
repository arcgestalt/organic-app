...
export default function BrandShowcase() {
  ...
  const wallpapers: Wallpaper[] = [
    {
      name: "Dark Black",
      laptopSrc: "/wallpaper/laptop/Dark Black.png",
      mobileSrc: "/wallpaper/mobile/Dark Black.png",
    },
    {
      name: "Dark",
      laptopSrc: "/wallpaper/laptop/Dark.png",
      mobileSrc: "/wallpaper/mobile/Dark.png",
    },
    {
      name: "Light",
      laptopSrc: "/wallpaper/laptop/Light.png",
      mobileSrc: "/wallpaper/mobile/Light.png",
    },
  ];
  ...
  const [previewDevice, setPreviewDevice] = useState<"laptop" | "mobile">(
    "laptop",
  );
    ...
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <header className="mb-16 text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-400">
          Explore and download official high-fidelity brand assets, logos, and
          edge-native optimized wallpapers.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
        ...
        <section className="rounded-3xl border border-white/10 bg-white/[0.02] p-8 backdrop-blur-md">
          ...
          <p className="mb-6 text-sm text-gray-400">
            Select any variant to inspect and download the official
            transparency-safe asset.
          </p>
          ...
          <div className="flex h-64 items-center justify-center rounded-2xl border border-white/5 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.03),transparent)] p-12 transition-all hover:border-white/10">
            <img
              ...
              className="max-h-full max-w-full object-contain drop-shadow-[0_0_24px_rgba(16,185,129,0.2)]"
            />
          </div>
        ...
        <section className="rounded-3xl border border-white/10 bg-white/[0.02] p-8 backdrop-blur-md flex flex-col justify-between">
          <div>
            ...
            <p className="mb-6 text-sm text-gray-400">
              Choose a design to preview and download for your matching screen.
            </p>
          </div>
          ...
          <div className="mt-6 flex flex-col gap-4">
            ...
            <div className="flex justify-between items-center bg-white/[0.02] border border-white/5 rounded-2xl p-4">
              <span className="text-sm font-semibold text-gray-300">
                ...
                ({previewDevice === "laptop" ? "Laptop" : "Mobile"})
              </span>
              <a
                href={
                  previewDevice === "laptop"
                    ? selectedWallpaper.laptopSrc
                    : selectedWallpaper.mobileSrc
                }
